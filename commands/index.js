...
module.exports = {
  ...
  Protect: require("./players/protect"),
  Resurrect: require("./celebs/resurrect"),
  RemovePick: require("./players/remove-pick")("!remove-pick"),
  ...
  Steal: require("./players/steal"),
  SubPoints: require("./points/sub-points"),
  Unpick: require("./players/remove-pick")("!unpick"),
  Unprotect: require("./players/unprotect"),
};
